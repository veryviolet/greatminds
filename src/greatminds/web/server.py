    ...
    def do_GET(self):
        try:
            ...
            if path in assets:
                ...
                if name == 'index.html':
                    content = content.replace(b'<html lang="en">', ('<html lang="en" data-default-language="' + self.server.service.default_language() + '" data-default-scale="' + self.server.service.default_scale() + '">').encode())
