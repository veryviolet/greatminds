...
def _resolvable_presets(monkeypatch):
    ...
    the lease-CLI tests here don't seed files, so stub the resolver
    (presets resolve, anything else raises like a missing profile file).
    Executor tests build ProfileSpec directly, unaffected."""
